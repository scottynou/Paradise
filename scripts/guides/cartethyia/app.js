...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/cartethyia/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/cartethyia/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/cartethyia/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "cartethyia";
...
async function fetchPage(route) {
  ...
  const response = await fetch("cartethyia/" + route + extension, {
