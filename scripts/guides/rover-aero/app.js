...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/rover-aero/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/rover-aero/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/rover-aero/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "rover-aero";
...
async function fetchPage(route) {
  ...
  const response = await fetch("rover-aero/" + route + extension, {
