...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/xiangli-yao/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/xiangli-yao/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/xiangli-yao/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "xiangli-yao";
...
async function fetchPage(route) {
  ...
  const response = await fetch("xiangli-yao/" + route + extension, {
