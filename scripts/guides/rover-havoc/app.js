...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/rover-havoc/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/rover-havoc/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/rover-havoc/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "rover-havoc";
...
async function fetchPage(route) {
  ...
  const response = await fetch("rover-havoc/" + route + extension, {
