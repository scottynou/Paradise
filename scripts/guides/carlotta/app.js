...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/carlotta/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/carlotta/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/carlotta/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
async function fetchPage(route) {
  ...
  const response = await fetch("carlotta/" + route + extension, {
