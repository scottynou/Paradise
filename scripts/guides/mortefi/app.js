...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/mortefi/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/mortefi/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/mortefi/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
async function fetchPage(route) {
  ...
  const response = await fetch("mortefi/" + route + extension, {
