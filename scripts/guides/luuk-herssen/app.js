...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/luuk-herssen/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/luuk-herssen/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/luuk-herssen/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "luuk-herssen";
...
async function fetchPage(route) {
  ...
  const response = await fetch("luuk-herssen/" + route + extension, {
