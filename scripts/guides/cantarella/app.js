...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/cantarella/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/cantarella/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/cantarella/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "cantarella";
...
async function fetchPage(route) {
  ...
  const response = await fetch("cantarella/" + route + extension, {
