...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/chisa/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/chisa/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
...
async function fetchPage(route) {
  ...
  const response = await fetch("chisa/" + route + extension, {
