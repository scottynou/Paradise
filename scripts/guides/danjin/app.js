...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/danjin/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/danjin/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
...
async function fetchPage(route) {
  ...
  const response = await fetch("danjin/" + route + extension, {
