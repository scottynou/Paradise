...
const PAGES = {
  ...
  armes: {
    title: "Armes",
    label: "Armes",
    js: ["../../scripts/guides/rover-spectro/armes.js"],
  },
  echo: {
    title: "Echo",
    label: "Echo",
  ...
  sequence: {
    title: "Sequence",
    label: "Sequence",
    js: ["../../scripts/guides/rover-spectro/sequence.js"],
  },
  "stat-endgame": {
    title: "Stats endgame",
    label: "Stats endgame",
  ...
  team: {
    ...
    js: [
      ...
      "../../scripts/guides/rover-spectro/team.js",
    ],
  },
  resume: {
    title: "Resume",
...
const CHARACTER_SLUG = "rover-spectro";
...
async function fetchPage(route) {
  ...
  const response = await fetch("rover-spectro/" + route + extension, {
